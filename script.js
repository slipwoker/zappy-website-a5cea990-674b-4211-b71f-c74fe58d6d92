  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (isRequired && value === '') {
        ...
        showError(field, customMessage || `${labelText} is required.`);
        return false;
      }
      ...
      if (value !== '') {
        ...
        if (maxLength && value.length > parseInt(maxLength, 10)) {
          showError(field, customMessage || `Maximum ${maxLength} characters allowed.`);
          return false;
        }
      }
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (submitButton) {
        ...
        submitButton.textContent = submitButton.getAttribute('data-sending-text') || 'Sending…';
      }
      ...
      fetch(action, {
        ...
        .catch(function () {
          ...
          errorEl.textContent =
            contactForm.getAttribute('data-error-message') ||
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'a5cea990-674b-4211-b71f-c74fe58d6d92',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'a5cea990-674b-4211-b71f-c74fe58d6d92';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'a5cea990-674b-4211-b71f-c74fe58d6d92';
